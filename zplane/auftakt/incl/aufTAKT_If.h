...
public:
    ...
    *
	...
	/*!
	* this method is experimental and must not be used.
	*/
    virtual int     GetResult (CaufTAKTResultIf *pResult, eTempoModes_t eTempoMode = kDynamicTempo) = 0;
